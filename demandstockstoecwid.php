...
//  запрос расширенных остатков по товару
        $urlStock = "/api/remap/1.2/report/stock/all?stockType=quantity&groupBy=consignment&includeRelated=true&include=zeroLines&filter=product=".$item['assortment']["meta"]["href"];
        try
        {
